...
<!-- footer start-->
    ...
    <!-- slick js start -->
    <script src="../admin/js/slick.js"></script>
    <!-- slick js end -->
    ...
    <script src="../admin/js/chart/apex-chart/chart-custom.js"></script>
    <!-- Apexchar js start -->
    <!-- ratio start  -->
    ...
    <script src="../admin/js/vector-map/map-vector.js"></script>
    <!-- vector map end -->
    <!-- Theme js-->
