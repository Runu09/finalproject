							...
							<div class="faq-tab">
								<ul class="nav nav-tabs" id="top-tab" role="tablist">
									<li class="nav-item"><a data-bs-toggle="tab"
										class="nav-link active" href="#dashboard">my onair</a></li>
									<li class="nav-item"><a data-bs-toggle="tab"
										class="nav-link" href="#profile">회원정보수정</a></li>
									<li class="nav-item"><a data-bs-toggle="tab"
										class="nav-link" href="#bookings">항공권이용내역</a></li>
									<li class="nav-item"><a data-bs-toggle="tab"
										class="nav-link" href="#change-pwd"> 비밀번호변경</a></li>
									<li class="nav-item"><a data-bs-toggle="tab"
										class="nav-link" href="#delete-account">회원탈퇴</a></li>
								</ul>
							</div>
						</div>
					</div>
										...
										<ul>
											<li>
												<div class="details">
													...
													<div class="right">
														<input class="form-control" type="userId" required=""
												...
												<div class="details">
													...
													<div class="right">
														<div class="row g-2">
															...
															<div class="col-4">
																<input id="hp2" class="form-control" type="text"
																	required="" name="hp2" placeholder="">
															</div>
															<div class="col-4">
																<input id="hp3" class="form-control" type="text"
																	required="" name="hp3" placeholder="">
															</div>
														</div>
													</div>
												</div>
									...
									<div class="dashboard-detail">
										<div class="delete-section">
											...
											<input class="form-control" type="password" name="newPwd1"
												...
												required="" placeholder="새 비밀번호 확인"><br> <a
												href="#" data-bs-toggle="modal" data-bs-target="#change-pwd"
