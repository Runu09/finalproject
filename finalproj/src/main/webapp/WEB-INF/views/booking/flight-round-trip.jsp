                    ...
                    <form class="row m-0">
                        <div class="col-lg-2">
                            <div class="form-group">
                                <label>출발지</label>
                                <input type="text" class="form-control open-select" value="서울/김포" placeholder="from" id="departure">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <label>도착지</label>
                                <input type="text" class="form-control open-select" value="부산/김해" placeholder="to" id="arrival">
