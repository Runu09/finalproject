...
<!-- 페이징 처리위한 form -->
<form action="<c:url value='/voc/voc_mylist'/>" method="post" name=frmPage>
							...
							<div class="flight-search">
								...
								<div class="flight-search-detail"
									...
									<form class="row m-0" name="frmSearch" method="post"
										action="<c:url value='/voc/voc_mylist'/>">
						...
						<div class="blog-wrapper">
							...
							<div class="sidebar-content">
								<ul class="sidebar-list">
									...
									<li class=""><a href="<c:url value='/voc/voc_list'/>"> <i aria-hidden="true"
