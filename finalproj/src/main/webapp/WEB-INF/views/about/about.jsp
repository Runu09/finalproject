                ...
                <div class="col-xl-5">
                    <div class="about-text pl-0">
                        <div>
                            ...
                            <p>많은 사람들이 코로나로 인해 여행 및 이동에 대한 부담감이 있었지만,<br>
								점점 확진자가 줄며 많이 완화가 되어, 이제는 자유롭게 국내여행이<br> 가능해지고 일상 회복이 진행 중입니다.<br>
								그로 인해 국내 여행을 다니시는 분들도 확실히 많이 늘었습니다.<br><br>
								
								현재 많은 항공권 예매사이트나 어플리케이션이 있습니다.<br>
								저희도 여러 사이트를 참고하면서 좋은 부분은 따라하고,<br>
								부족한 부분은 채워나가며 이러한 사이트를 만들어보면<br> 좋을 듯 하다고 생각하며
								프로젝트를 기획했습니다.</p>
