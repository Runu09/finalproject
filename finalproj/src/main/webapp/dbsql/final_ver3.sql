...
CREATE TABLE MEMBER (
	...
	M_ZIPCODE VARCHAR2(150) NOT NULL, /* 우편번호 */
	M_ADD1 VARCHAR2(150) NOT NULL, /* 주소 */
...
CREATE TABLE BOARD (
	...
	B_GROUPNO NUMBER DEFAULT 0, /* 그룹번호 */
	B_STEP NUMBER DEFAULT 0, /* 글의 단계 */
	B_SORTNO NUMBER DEFAULT 0, /* 글의 정렬순서 */
	B_DELFLAG CHAR DEFAULT 'N', /* 삭제 flag */										   																			  
